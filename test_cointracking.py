...
# ========================================================================================
    def test_coinbase(self):
        output, exchange_trades_input_count, all_records = CT.group_xml(CT.get_args(), "test_coinbase.xml", dumb_group_for_early_dates=False)
...
# ========================================================================================
    def test_coinbase2(self):
        ...
        output, exchange_trades_input_count, all_records = CT.group_xml(CT.get_args(), "test_coinbase.xml", dumb_group_for_early_dates=True)
        self.assertEqual(exchange_trades_input_count["Coinbase"], 56)
...
# ========================================================================================
    def test_wallet2(self):
        ...
        output, exchange_trades_input_count, all_records = CT.group_xml(CT.get_args(), "test_wallet.xml", dumb_group_for_early_dates=True)
        self.assertEqual(exchange_trades_input_count["ETH Wallet"], 45)
